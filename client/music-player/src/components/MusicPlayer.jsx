    ...
    <div className="w-full full flex items-center gap-3 ">
      ...
      >
        ...
        <div className="flex flex-col items-start">
          {/* //*this p tags has NAME AND ALBUM */}
          ...
          {/* //*this p tags has ARTISTS AND CATEGORY */}
...
export const PlayListCard = () => {
  ...
  const setCurrentPlaySong = (songIn) => {
    if (!isSongPlaying) {
      dispatch({
        type: actionType.SET_IS_SONG_PLAYING,
        isSongPlaying: true,
  ...
  return (
    <div className="absolute left-4 bottom-24 gap-2 py-2 w-290 max-w-[290px] h-[340px] max-h-[340px] flex flex-col overflow-y-scroll scrollbar-thin rounded-md shadow-md bg-primary">
      {allSongs.length > 0 ? (
